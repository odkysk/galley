...
<div class="container mx-auto px-4 py-8">
  <div class="text-center mb-12">
    ...
    <p class="text-xl text-gray-600 max-w-2xl mx-auto">
      Welcome to the Galley demonstration! This showcases the power of our banner generation system.
      Create stunning graphics with our template library or build your own custom templates.
    </p>
